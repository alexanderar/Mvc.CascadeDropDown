// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CascadeDropDownOptions.cs">
//   
// </copyright>
// <summary>
//   The cascade drop down options.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Mvc.CascadeDropDown.Infrastructure
{
    ...
    public class CascadeDropDownOptions
    {
        ...
        ///     Function gets as argument an object that is going to be sent to the server (By default will have single property
        ///     with name specified in ajaxActionParamName and the value of parent dropdown)
        ...
        /// <summary>
        ///   Gets or sets the HTTP method  GET or POST (GET is default)
        /// </summary>
        public string HttpMethod { get; set; }

        /// <summary>
        ///     Gets or sets the JavaScript function to call when get data request is completed (both in case of success and
        ///     failure).
        /// </summary>
